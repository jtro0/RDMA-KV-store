...
{\huge \bfseries Scalability of RDMA transportation types in a Key Value store application\par}\vspace{0.4cm}
...
{\it daily supervisor:} & ~~Dr. Animesh Trivedi \\
{\it 2nd reader:}       & ~~Jesse Donkervliet
\end{tabular}
...
\include{5_related_work/relatedwork}

\include{6_Future_improvements/futureimprovements}
