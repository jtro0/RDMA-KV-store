...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[]{/home/jtroo/Documents/VU/Thesis/RDMA-KV-store/write_up/figures/PDF/request}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics{/home/jtroo/Documents/VU/Thesis/RDMA-KV-store/write_up/figures/PDF/method}
        \caption{Values for method}
        \label{fig:method}
    \end{subfigure}
