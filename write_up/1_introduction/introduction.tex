...
\begin{itemize}
    \item[\textbf{RQ1}] How scalable are the RDMA transportation types: reliable connection (RC), unreliable connection (UC), and unreliable datagram (UD)?%, compared to traditional TCP?
